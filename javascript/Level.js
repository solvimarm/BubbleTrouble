...
function createLEVELS(g_sprites) {
    var LEVELS = [
        ...
        _createSingleLevel( // Level 8
            ...
            levelTime = 15, 
            balls = [
                {cx: 50, cy: 455, velX: 1, size: 0},
                {cx: 70, cy: 455, velX: 1, size: 0},
                {cx: 90, cy: 455, velX: 1, size: 0},
                {cx: 110, cy: 455, velX: 1, size: 0},
                {cx: 130, cy: 455, velX: 1, size: 0},
                {cx: 150, cy: 455, velX: 1, size: 0},
                {cx: 170, cy: 455, velX: 1, size: 0},
                {cx: 190, cy: 455, velX: 1, size: 0},
                {cx: 210, cy: 455, velX: 1, size: 0},
                {cx: 230, cy: 455, velX: 1, size: 0},
